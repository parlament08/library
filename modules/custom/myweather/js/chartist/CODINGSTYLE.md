...
`<script src="myweather.js"></script>` will block the whole DOM parsing until the script has fully loaded and executed. This
...
<html>
  ...
  <body>
    ...
    <script src="myweather.js" async></script>
  </body>
</html>
```
...
<body>
  ...
  <script async src="myweather.js"></script>
</body>
</html>
```
...
<script src="myweather.js" type="text/javascript"></script>
```
